  ...
  timeUpEvent.on("timeUp", (answerInfo) => {
    ...
    if (attempt) {
      if(attempt === answerInfo[0]) {
        // console.log((answerInfo[2]*1000)-answerInfo[1].diff(timestamp))
        // console.log((answerInfo[2]*1000))
        // console.log(answerInfo[1])
        // console.log(timestamp)
        // console.log(answerInfo[1].diff(timestamp))
        // console.log(userPointsMap[socket.id][0])
